...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Origin — Your life operating system" },
      { name: "description", content: "A calm, AI-powered home for your day: tasks, habits, calendar, mood, and thinking — in one place." },
      { name: "author", content: "Origin" },
      { property: "og:title", content: "Origin — Your life operating system" },
